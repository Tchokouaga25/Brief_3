                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Connexion</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Déconnexion</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php if (!empty($history)): ?>
                                <?php foreach ($history as $session): ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?= htmlspecialchars($session['user_name'] ?? 'Utilisateur inconnu') ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?= htmlspecialchars($session['login_formatted'] ?? 'Non disponible') ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        <?= htmlspecialchars($session['logout_formatted'] ?? 'En cours') ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-blue-600 font-medium">
                                        <?= htmlspecialchars($session['duree'] ?? '-')?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                <?php else: ?>
