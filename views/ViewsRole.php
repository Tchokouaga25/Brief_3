    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="../Router/Router.php?action=add" method="POST">
            <div class="flex flex-col md:flex-row justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Gestion des roles Utilisateurs</h1>
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <form method="POST" action="../Router/Router.php?action=edit" class="inline">
                                        ...
                                        <button type="submit" class="p-2 text-blue-500 hover:bg-red-100 rounded-lg ">
                                            Modifier<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <!-- Bouton Mise à jour -->
                                    <a href="update_user.php?id=<?= $user['role_id'] ?>" class="p-2 text-green-500 hover:bg-green-100 rounded-lg">
                                        mise a jour<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
