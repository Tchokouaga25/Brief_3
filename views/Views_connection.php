...
<section class=" overflow-hidden flex items-center justify-center ">
    ...
    <form action="../Router/Router.php?action=login" method="POST" class="flex items-center justify-center overflow-hidden shadow-md  bg-[#D9D9D9] max-w-screen-md px-4 md:py-20 md:px-8">
        
            <div class="relative flex-1 hidden w-50 overflow-hidden h-130 lg:block">
                <img class="absolute inset-0 object-cover w-full h-full bg-blue-500" src="/images/placeholders/original/1000x1000.webp"
                alt="" />
            </div>
            <div class="flex flex-col justify-center flex-1 px-4  overflow-hidden sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                <div class="w-full max-w-xl mx-auto lg:w-96">
                    <div >
                        <h2 class=" text-3xl font-extrabold text-gray-600">Se Connecter.</h2>
                    </div>
                    <button  type="submit"
