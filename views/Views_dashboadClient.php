        ...
        <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    ...
                    <a href="C:\xampp\htdocs\brief-final\views\ViewsHistorique.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white"> Historique de connection</a>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div>
                        ...
                        <img class="size-8 rounded-full" src="C:/Users/claude sandra/Downloads/d44e6eab2fd07c0eab1dd08e26f2d6c3" alt="">
                        </button>
                    </div>
                    ...
                    <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ring-1 shadow-lg ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        ...
                        <a href="../Router.php?action=logout" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">se deconnecter</a>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                <a href="../Router/Router.php?action=history" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">historique de connection</a>
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                    ...
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="C:/Users/claude sandra/Downloads/d44e6eab2fd07c0eab1dd08e26f2d6c3" alt="">
                    </div>
                    <div class="ml-3">
                    ...
                    <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"></a>
                    <a href="../Router/Router.php?action=login" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Se deconnecter</a>
                    </div>
            </div>
            </div>
        </nav>
